 ...
 */
@Stateless
public class TipoMascotasFacade extends AbstractFacade<TipoMascotas> implements TipoMascotasFacadeLocal {
    ...
    public TipoMascotasFacade() {
        super(TipoMascotas.class);
    }
